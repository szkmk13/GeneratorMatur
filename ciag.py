...
def arytmetyczny_zamkniete():
    ...
    if ktore == 0:
        f.write(f'W ciągu arytmetycznym pierwszy wyraz jest równy {a1}, a {slownie(wyraz)}  jest równy {awyraz}. Oblicz '
            f'{slownie(wyraz2)} \n\n')
    elif ktore == 1:
        f.write(
...
def geometryczny_zamkniete():
    ...
    if ktore == 0:
        f.write(f'Dany jest ciąg geometryczny którego {slownie(wyraz)} to {awyraz} i a1 = {a1}. Oblicz iloczn tego ciągu\n\n')
    elif ktore == 1:
        f.write(f'W ciągu geometrycznym {slownie(wyraz)} to {awyraz} a {slownie(wyraz2)} jest równy {awyraz2} olblicz iloczyn tego ciągu\n\n')
    elif ktore == 2:
        f.write(f'W ciągu geometrycznym {slownie(wyraz)} to {awyraz} a {slownie(wyraz2)} jest równy {awyraz2} olblicz pierwszy wyraz tego ciągu\n\n')
    elif ktore == 3:
        f.write(f'{suma_n_wyrazow_geometryczny(a1,q,n)} to suma pierwszych {n} wyrazów ciągu geometrycznego w któym a1={a1} oblicz iloczyn tego ciągu\n\n')
    elif ktore == 4:
        f.write(
